...
// NewEpisodeAction creates an EpisodeStorageAction with the mock genkit
func (h *TestHelper) NewEpisodeAction() *EpisodeStorageAction {
	return NewEpisodeStorageAction()
}

// NewEpisodeStorageAction is an alias for NewEpisodeAction
func (h *TestHelper) NewEpisodeStorageAction() *EpisodeStorageAction {
	return NewEpisodeStorageAction()
}

// NewExtractionAction creates an ExtractionAction with the mock genkit
func (h *TestHelper) NewExtractionAction() *ExtractionAction {
	return NewExtractionAction()
}

// NewSummaryAction creates a SummaryAction with the mock genkit
func (h *TestHelper) NewSummaryAction() *SummaryAction {
	return NewSummaryAction()
}

// NewRetrievalAction creates a RetrievalAction with the mock genkit
func (h *TestHelper) NewRetrievalAction() *RetrievalAction {
	return NewRetrievalAction()
}
